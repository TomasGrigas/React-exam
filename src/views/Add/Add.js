...
import { BackgroundColor, ButtonStyle, ErrorColor, InputStyle, LinkColor, MenuStyle } from "../../components/styledComponents";
  ...
  return (
    <BackgroundColor>
        ...
        <form onSubmit={handleSkills}>
            <InputStyle>
              <input value ={title} onChange ={(e)=>setTitle(e.target.value)} type="text" placeholder = "Add your skill"/>
